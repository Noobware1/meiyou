...
abstract interface class ContentWidget extends Widget {
  ...
  factory ContentWidget({
    ...
    if (content.isAnime) {
      return AnimeWidget(content: content as Anime, onSelected: onSelected);
    } else if (content.isSeries) {
      return SeriesWidget(content: content as Series, onSelected: onSelected);
    } else if (content.isMovie) {
      return MovieWidget(content: content as Movie, onSelected: onSelected);
