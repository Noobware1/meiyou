  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        await saveData(
            savePath:
                '${RepositoryProvider.of<AppDirectories>(context).settingsDirectory.path}\\theme.json',
            data: jsonEncode(
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              addVerticalSpace(20),
              AppTheme.builder(
                builder: (context, state) => _TextInsideTextButton(
                  outerText: 'Dark Mode',
...
class _TextInsideTextButton extends StatelessWidget {
  final String outerText;
  final String innerText;
  final void Function() onTap;
  const _TextInsideTextButton(
      {super.key,
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(innerText,
                  style: TextStyle(
                      fontSize: isMobile ? 13 : 15, color: Colors.grey)),
            ),
            addVerticalSpace(5),
          ],
        ),
