...
const Curve _modalAdaptiveSheetCurve = Easing.standardDecelerate;
...
///
/// Used by [AdaptiveSheet.onDragStart].
...
///
/// Used by [AdaptiveSheet.onDragEnd].
typedef BottomSheetDragEndHandler = void Function(
  DragEndDetails details, {
  required bool isClosing,
});

class AdaptiveSheet extends StatefulWidget {
  const AdaptiveSheet({
    super.key,
  ...
  /// exit animations.
  ///
  /// The AdaptiveSheet widget will manipulate the position of this animation, it
  ...
  /// Use [AdaptiveSheet.createAnimationController] to create one, or provide
  ...
  /// Defines minimum and maximum sizes for a [AdaptiveSheet].
  ///
  ...
  @override
  State<AdaptiveSheet> createState() => _BottomSheetState();

  /// Creates an [AnimationController] suitable for a
  /// [AdaptiveSheet.animationController].
  ///
  ...
  static AnimationController createAnimationController(TickerProvider vsync,
    ...
    return AnimationController(
      duration: sheetAnimationStyle?.duration ?? _adaptiveSheetEnterDuration,
      reverseDuration:
          sheetAnimationStyle?.reverseDuration ?? _adaptiveSheetExitDuration,
      debugLabel: 'AdaptiveSheet',
      vsync: vsync,
    );
  }
}

class _BottomSheetState extends State<AdaptiveSheet> {
  final GlobalKey _childKey = GlobalKey(debugLabel: 'AdaptiveSheet child');
  ...
  void _handleDragUpdate(DragUpdateDetails details) {
    assert(
      ...
      "'AdaptiveSheet.animationController' cannot be null when 'AdaptiveSheet.enableDrag' or 'AdaptiveSheet.showDragHandle' is true. "
      "Use 'AdaptiveSheet.createAnimationController' to create one, or provide another AnimationController.",
    );
    if (_dismissUnderway) {
      return;
    }
...
class _AdaptiveSheetLayoutWithSizeListener
    extends SingleChildRenderObjectWidget {
  const _AdaptiveSheetLayoutWithSizeListener({
  ...
  @override
  _RenderAdaptiveSheetLayout createRenderObject(BuildContext context) {
    return _RenderAdaptiveSheetLayout(
  ...
  void updateRenderObject(
      BuildContext context, _RenderAdaptiveSheetLayout renderObject) {
...
class _RenderAdaptiveSheetLayout extends RenderShiftedBox {
  _RenderAdaptiveSheetLayout({
    RenderBox? child,
...
class _ModalAdapativeSheet<T> extends StatefulWidget {
  const _ModalAdapativeSheet({
    super.key,
    required this.route,
    this.backgroundColor,
    this.elevation,
  ...
  final ModalAdaptiveSheetRoute<T> route;
  final bool isScrollControlled;
  final double scrollControlDisabledMaxHeightRatio;
  final Color? backgroundColor;
  final double? elevation;
  ...
  @override
  _ModalAdapativeSheetState<T> createState() => _ModalAdapativeSheetState<T>();
}

class _ModalAdapativeSheetState<T> extends State<_ModalAdapativeSheet<T>> {
  ParametricCurve<double> animationCurve = _modalAdaptiveSheetCurve;
  ...
  void handleDragEnd(DragEndDetails details, {bool? isClosing}) {
    animationCurve = Split(
      ...
      endCurve: _modalAdaptiveSheetCurve,
    );
  }
    ...
    return AnimatedBuilder(
      ...
      builder: (BuildContext context, Widget? child) {
        ...
        return Semantics(
          ...
          child: ClipRect(
            child: _AdaptiveSheetLayoutWithSizeListener(
...
class ModalAdaptiveSheetRoute<T> extends PopupRoute<T> {
  /// A modal bottom sheet route.
  ModalAdaptiveSheetRoute({
    required this.builder,
    this.capturedThemes,
    this.barrierLabel,
  ...
  /// bottom sheet.
  ///
  /// Consider setting this attribute when the [ModalAdaptiveSheetRoute]
  ...
  /// [AdaptiveSheet.createAnimationController].
  ///
  ...
  /// underlying [AdaptiveSheet.createAnimationController].
  ///
  /// To disable the modal bottom sheet animation, use [AnimationStyle.noAnimation].
  final AnimationStyle? sheetAnimationStyle;

  /// {@template flutter.material.ModalAdaptiveSheetRoute.barrierOnTapHint}
  ...
  /// the barrier for this [ModalAdaptiveSheetRoute] should be clipped.
  ///
  ...
  @override
  Duration get transitionDuration => _adaptiveSheetEnterDuration;

  @override
  Duration get reverseTransitionDuration => _adaptiveSheetExitDuration;
  ...
  AnimationController createAnimationController() {
    ...
    if (transitionAnimationController != null) {
      ...
      _animationController = AdaptiveSheet.createAnimationController(
        navigator!,
...
///
/// {@macro flutter.material.ModalAdaptiveSheetRoute}
///
...
/// display the [AdaptiveSheet] when set to `true`. This is useful in the case
/// that a modal [AdaptiveSheet] needs to be displayed above all other content
...
///
/// {@tool dartpad}
/// This example demonstrates how to use [showModalAdaptiveSheet] to display a
...
///
/// {@tool dartpad}
/// This sample shows the creation of [showModalAdaptiveSheet], as described in:
...
///
/// {@tool dartpad}
/// This sample showcases how to override the [showModalAdaptiveSheet] animation
...
/// See also:
///
///  * [AdaptiveSheet], which becomes the parent of the widget returned by the
///    function passed as the `builder` argument to [showModalAdaptiveSheet].
...
///    animation duration and reverse animation duration.
Future<T?> showModalAdaptiveSheet<T>({
  ...
  return navigator.push(ModalAdaptiveSheetRoute<T>(
    builder: builder,
    capturedThemes:
...
/// persistent bottom sheets (see the documentation for these on [AdaptiveSheet]
/// for more details).
///
...
/// [showModalAdaptiveSheet] function.
///
...
///  * [AdaptiveSheet], which becomes the parent of the widget returned by the
///    `builder`.
///  * [showModalAdaptiveSheet], which can be used to display a modal bottom
///    sheet.
...
// BEGIN GENERATED TOKEN PROPERTIES - AdaptiveSheet
...
// END GENERATED TOKEN PROPERTIES - AdaptiveSheet
