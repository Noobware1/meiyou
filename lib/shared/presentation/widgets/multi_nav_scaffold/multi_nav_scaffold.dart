...
part 'side_bar_transition.dart';
part 'bottom_bar_transition.dart';

class MultiNavScaffold extends StatefulWidget {
  const MultiNavScaffold({
    Key? key,
    this.appBar,
    this.body,
...
class _MultiNavScaffoldState extends State<MultiNavScaffold>
  ...
  late final _controller = AnimationController(
      ...
      value: 0,
      vsync: this);
  late final _sideAnimation = _SideAnimation(parent: _controller);
  late final _sideFabAnimation = _SideFabAnimation(parent: _controller);
  late final _barAnimation = _BarAnimation(parent: _controller);
  ...
  void didChangeDependencies() {
    ...
    final ScreenSize screenSize = context.screenSize;
    ...
    if (!controllerInitialized) {
      ...
      _controller.value = screenSize != ScreenSize.mobile ? 1 : 0;
    }
  }
    ...
    return AnimatedBuilder(
        ...
        builder: (context, _) {
          return Scaffold(
            ...
            body: widget.sideNavigatonBar == null
                ? widget.body
                : Row(
                    children: [
                      _DisappearingSideNavigationBar(
                        railAnimation: _sideAnimation,
                        railFabAnimation: _sideFabAnimation,
                        navigationBar: widget.sideNavigatonBar!,
                      ),
                      Expanded(child: widget.body ?? defaultSizedBox),
                    ],
                  ),
            ...
            bottomNavigationBar: widget.bottomNavigationBar == null
                ? null
                : _DisappearingBottomNavigationBar(
