...
import 'package:meiyou/core/bridge/bridge_models/external_id.dart';
...
class $MediaDetails implements MediaDetails, $Instance {
  ...
  static const $declaration = BridgeClassDef(BridgeClassType($type),
          ...
          BridgeFunctionDef(
            ...
            namedParams: [
              ...
              BridgeParameter('mediaItem',
                  BridgeTypeAnnotation($MediaItemEntity.$type, nullable: true), true),
            ],
          ),
        ),
      },
      fields: {
        ...
        'mediaItem': BridgeFieldDef(
          BridgeTypeAnnotation($MediaItemEntity.$type, nullable: true),
        ),
      },
      methods: {
    ...
    switch (identifier) {
      ...
      case 'mediaItem':
        return $value.mediaItem != null
            ? $MediaItemEntity.wrap($value.mediaItem!)
            : const $null();
  ...
  void $setProperty(Runtime runtime, String identifier, $Value value) {
    switch (identifier) {
      ...
      case 'mediaItem':
        $value.mediaItem = value.$reified as MediaItemEntity?;
  ...
  @override
  MediaItemEntity? get mediaItem => $value.mediaItem;

  @override
  set bannerImage(String? _bannerImage) {
  ...
  @override
  set endDate(DateTime? _endDate) {
    // TODO: implement endDate
  }

  @override
  set externalIds(List<ExternalIdEntity>? _externalIds) {
    // TODO: implement externalIds
  }

  @override
  set genres(List<String>? _genres) {
    // TODO: implement genres
  }

  @override
  set mediaItem(MediaItemEntity? _mediaItem) {
  ...
  @override
  set otherTitles(List<String>? _otherTitles) {
    // TODO: implement otherTitles
  }

  @override
  set posterImage(String? _posterImage) {
  ...
  @override
  set recommendations(List<SearchResponseEntity>? _recommendations) {
    // TODO: implement recommendations
  }

  @override
  set startDate(DateTime? _startDate) {
    // TODO: implement startDate
  }

  @override
  set status(ShowStatus? _status) {
    // TODO: implement status
  }

  @override
  set type(ShowType _type) {
    // TODO: implement type
  }
  ...
  @override
  set actorData(List<ActorDataEntity>? _actorData) {
