...
//Copied from https://github.com/felangel/bloc/blob/master/packages/bloc_concurrency/lib/src/restartable.dart
EventTransformer<Event> restartable<Event>() {
  return (events, mapper) => events.switchMap(mapper);
}

//Copied from https://github.com/dart-lang/stream_transform/blob/master/lib/src/switch.dart
