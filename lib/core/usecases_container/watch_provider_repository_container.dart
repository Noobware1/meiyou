...
class WatchProviderRepositoryContainer
  ...
  Map<String, UseCase> get usecases => {
        loadSearchUseCase: LoadSearchUseCase(_repository),
        findBestSearchResponseUseCase:
            FindBestSearchResponseUseCase(_repository),
        loadEpisodesUseCase: LoadEpisodeUseCase(_repository),
        loadMovieUseCase: LoadMovieUseCase(_repository),
        loadSeasonUseCase: LoadSeasonsUseCase(_repository),
        loadVideoExtractorUseCase: LoadVideoExtractorUseCase(_repository),
        loadVideoServersUseCase: LoadVideoExtractorUseCase(_repository),
        getEpisodeChunksUseCase: GetEpisodeChunksUseCase(_repository),
      };
}
