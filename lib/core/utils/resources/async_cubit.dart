...
abstract class AsyncCubit<T> extends Cubit<AsyncValue<T>> {
  ...
  AsyncCubit.loading() : super(const AsyncValue.loading());

  AsyncCubit.data(T data) : super(AsyncValue.data(data));

  AsyncCubit.error(Object error, [StackTrace? stackTrace])
      : super(AsyncValue.error(error, stackTrace ?? StackTrace.current));

  void future(Future<T> Function() future) async {
    ...
    try {
      ...
      emit(AsyncValue.error(err, stack));
    }
  }

  void emitError(Object error, [StackTrace? stackTrace]) {
    emit(AsyncValue.error(error, stackTrace ?? StackTrace.current));
  }
...
class AsyncData<T> extends AsyncValue<T> {
  ...
  Future<AsyncValue<R>> cast<R>() async {
